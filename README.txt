...
Etape 2.1 : terminée (fonction test_trigo dans le fichier signal.s appelée dans le fichier principal.c en passant l'index de l'angle voulu (entre 0 et 63) et un pointeur sur la variable dans laquelle le cosinus au carré + le sinus au carré doit être stocké)
